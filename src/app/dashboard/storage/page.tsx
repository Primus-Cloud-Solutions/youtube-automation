      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-700 rounded-md">
                <h3 className="font-medium text-green-400">Secure Cloud Storage</h3>
                <p className="text-sm text-gray-300 mt-1">
                  All your videos and assets are stored securely in the cloud with enterprise-grade encryption.
                </p>
              </div>
              
              <div className="p-4 bg-gray-700 rounded-md">
                <h3 className="font-medium text-green-400">Automatic Management</h3>
                <p className="text-sm text-gray-300 mt-1">
                  Files are automatically organized and managed based on your content creation activities.
                </p>
              </div>
              
              <div className="p-4 bg-gray-700 rounded-md">
                <h3 className="font-medium text-green-400">Fast Delivery</h3>
                <p className="text-sm text-gray-300 mt-1">
                  Global content delivery network ensures your videos load quickly for viewers anywhere in the world.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-gray-800 rounded-lg p-6 shadow-lg">
          ...
          {isLoading ? (
            <div className="space-y-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="animate-pulse h-16 bg-gray-700 rounded-md"></div>
              ))}
            </div>
          ) : files.length === 0 ? (
